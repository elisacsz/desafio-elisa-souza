...
describe('CaixaDaLanchonete', () => {
    ...
    const validaTeste = (metodoDePagamento, resultadoEsperado, itens) => {
    ...
    ])('compra %p em %p deve resultar em %p', (_, metodoDePagamento, resultadoEsperado, itens) =>
        validaTeste(metodoDePagamento, resultadoEsperado, itens));
